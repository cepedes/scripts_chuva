...
#   AUTOR DAS MOFIFICAÇÕES : [regis] REGINALDO VENTURA DE SA (reginaldo.venturadesa@gmail.com) 
#         
...
#
# em 05/09/2023 by regis :
#   (1) coloquei um verificador de existencia de arquivo baixado. ]
#    só baixa o que não existir no diretorio. para atualiar tem que apagar os csv
#   (2) coloquei um indicar do que esta acontecendo e contador do num de estacoes. 
#-----------------------------------------------------------------------------------------
...
for cod in cod_list:
  ...
  if os.path.exists(f'./{cod}.csv'):
       print(f"Arquivo para a estação {cod} já existe. Pulando para a próxima estação.")
       continue
...
#
  ...
  if juntar != []:
        print("(",num_estacoes,"/",n_estacao,") Estacao:",cod," contém dados")
        ...
        print("(",num_estacoes,"/",n_estacao,") Estacao:",cod," não contém dados")      